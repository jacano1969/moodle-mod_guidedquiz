...
// This script uses installed report plugins to print quiz reports
    ...
    require_once($CFG->dirroot.'/mod/guidedquiz/report/reportlib.php');
    ...
    require_capability('mod/guidedquiz:viewreports', $context);
    ...
    if ($attempts = get_records_sql("SELECT a.*".
           "  FROM {$CFG->prefix}guidedquiz_attempts a, {$CFG->prefix}question_states s".
    ...
    add_to_log($course->id, "guidedquiz", "report", "report.php?id=$cm->id", "$quiz->id", "$cm->id");
